    ...
    *************************************************
    ...
    def fp_msg_exchange(self, recv_buffer_cpu: Basic_Buffer_Type, recv_buffer_gpu: Basic_Buffer_Type, send_buffer_cpu: Basic_Buffer_Type, send_idx: Dict[int, Tuple[int, int]], send_messages: Tensor):
        ...
        for i in range(1, world_size):
            ...
            # async send
            print(send_buffer_cpu[right].data_ptr())
            print(recv_buffer_cpu[left].data_ptr())
            ...
            print("RECV: " + str(recv_buffer_cpu[left].get_device()) + " RANK: " + str(rank) + " LEFT: " + str(left))
            print(recv_buffer_cpu[left])
            req_send.append(r1)
            # async recv
